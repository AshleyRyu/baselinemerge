...
#         # tf.add_to_collection('target2', 20) ##A.R
#         # tf.add_to_collection('target1', 20) 
...
#         #     vs.reuse_variables()
#         #     print("batch= {}".format(target_batch_tf))
#         #     print("tf.variable_scope(target) = {}".format(tf.variable_scope('target')))
...
#         #     # elif rarget1: ##A.R
#         #     target_batch_tf = batch_tf.copy()
#         #     target_batch_tf['o'] = ['o_2']
#         #     target_batch_tf['g'] = batch_tf['g_2']
#         #     print("Debug, observation target1 high:{}".format(target_batch_tf['o']))
#         #     # print("target type : {}".format(type(target)))
#         #     self.target = self.create_actor_critic(
#         #         target_batch_tf, net_type='target', **self.__dict__)
#         #         #error발생; AttributeError: 'list' object has no attribute 'get_shape'
#         #     # print(type(target))
#         #     vs.reuse_variables()
#         # assert len(self._vars("main")) == len(self._vars("target1"))
...
#             # target_batch_tf['o'] = ['o_2']
#             # target_batch_tf['g'] = batch_tf['g_2']
#             # print("Debug, observation target2 high:{}".format(target_batch_tf['o']))
#             # self.target = self.create_actor_critic(
#             #     target_batch_tf, net_type='target', **self.__dict__)
#             # # print(type(target))
#             # vs.reuse_variables()
...
#         # assert len(self._vars("main")) == len(self._vars("target"))
#         # assert len(self._vars("main")) == len(self._vars("target1")) or len(self._vars("main")) == len(self._vars("target2"))
...
#         target_Q_tf = tf.clip_by_value(batch_tf['r'] + self.gamma * target_Q_tf, *clip_range) #original code
...
#         if self.num_demo % self.td3_policy_freq == 0:
#             target1_Q_pi_tf = self.target1.Q_pi_tf ##A.R policy training
#             target2_Q_pi_tf = self.target2.Q_pi_tf ##A.R
#             target_Q_pi_tf = tf.minimum(target1_Q_pi_tf, target2_Q_pi_tf)
